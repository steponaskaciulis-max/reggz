        ...
        >
          {[
            ...
            },
            {
              ...
              description: 'We're committed to sustainable practices and ethical production. Fashion shouldn\'t cost the earth.',
              icon: '🌱',
            },
            {
              title: 'Authentic Style',
              description: 'Our designs reflect real style for real people. Timeless, versatile, and always on trend.',
              icon: '🎨',
            },
          ].map((value) => (
